# Can create a repo with:   curl -u admin:THEPASSWORD -X POST -H 'Accept: application/json' -H 'Content-Type: application/json' http://stash/projects/SER/repos/ -d '{\"name\": \"TravelRepublic.Propaganda.Service\"}'
